...
<body class="sidebar-mini layout-fixed sidebar-open" style="height: auto;">
						...
						<div class="col-md-8">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title"><strong>Por favor ingresar los datos solicitados para registrar reserva </strong></h3>
									...
									<div role="form">
											...
											<div class="col-6">
												...
												<div class="input-group mb-3">
													<select class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="25" tabindex="-1" aria-hidden="true" id="tEstadia">
														<option selected="selected" data-select2-id="estadia" value="reserva">Reserva</option>
													</select>
												</div>
											</div>
											<div class="col-6">
										...
										<div class="row">
											...
											<div class="col-3">
												...
												<input type="number" class="form-control" placeholder="Elija fechas" id="peh1" disabled="true">
											</div>
										</div>
										<br/>
										<!-- SEPARADOR -->
	...
	<script type="text/javascript" src="includes/ajax/Registros/rReserva.js"></script>
