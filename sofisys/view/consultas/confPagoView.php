...
<body class="sidebar-mini layout-fixed sidebar-open" style="height: auto;">
						...
						<div class="col-md-8">
							<div class="card card-primary">
								<div class="card-header">
									<h2 class="card-title"><strong>Confirmar estadía por reserva registrando el pago</strong></h2>
	...
	<script type="text/javascript" src="includes/ajax/Registros/confPago.js"></script>
